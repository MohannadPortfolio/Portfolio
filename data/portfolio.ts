export const projects = [
    {
        title: "Isoko NFT Marketplace",
        description:
            "Fully functional NFT marketplace built on Kadena blockchain where users can mint, buy, sell, and view their NFTs.",
    ...
    },
    {
        ...
        description:
            "Landing page where Kadcar GameFi NFTs are sold and NFT owners can view their collections.",
    ...
    },
    {
        title: "kad_py_lib",
        description:
            "Python library to provide signing and sending pact commands on the Kadena blockchain.",
    ...
    },
    {
        title: "kad_cs",
        description:
            "C# library to provide signing and sending pact commands on the Kadena blockchain.",
